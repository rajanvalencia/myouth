...
@WebServlet("/apis/ajax/forms/editQuestion")
public class EditQuestion extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        String question = request.getParameter("question").replaceAll("<div><br></div>", "").replaceAll("<br>", "");
        ...
        String prevQuestion = db1.getQuestion(questionId);
        Boolean res = db1.updateQuestion(questionId, question);
        db1.close();
        
        Notifications db2 = new Notifications();
        db2.open();
        db2.insertEventNotification(event, userId,"が「"+title+"」の質問「"+prevQuestion+"」を「"+question+"」に変更しました。");
        db2.close();
