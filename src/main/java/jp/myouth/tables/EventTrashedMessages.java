...
public class EventTrashedMessages {
	...
	public void append(HttpServletRequest request) {
		...
		db.open();
		ArrayList<String> data = db.eventTrashedMessages(event);
		db.close();
		...
		for(String string : data) {
			if(i % 4 == 0)
				result += "<tr><td><a href=\"/home/"+event+"/mail/trashed/"+string+"\" style=\"color: #777;\"><div class=\"row gtr-50 gtr-uniform\">";
			else if(i % 4 == 1)
		...
		request.setAttribute("eventTrashedMessages", result);
	}
}
