...
public class EventTrashedMessage {
	...
	public void append(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		db.open();
		ArrayList<String> data = db.eventTrashedMessage(transactionId);
		...
		for(String string : data) {
			if(i % 3 == 0) {
				...
				result += "\n\t\t\t\t\t\t\t\t\t\t\t\t\t"+string+
						...
						+ "\n\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"/home/"+event+"/mail/trashed/"+transactionId+"/undo\"><span class=\"fa fa-undo fa-2x\" style=\"color: #e89980; border-bottom-color: transparent;\"></span></a>"
						+ "\n\t\t\t\t\t\t\t\t\t\t\t\t</div>"
						+ "\n\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-1 col-2-mobile\">"
						+ "\n\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"/home/"+event+"/mail/trashed/"+transactionId+"/delete\"><span class=\"fa fa-trash fa-2x\" style=\"color: #e89980; border-bottom-color: transparent;\"></span></a>"
						+ "\n\t\t\t\t\t\t\t\t\t\t\t\t</div>"
						+ "\n\t\t\t\t\t\t\t\t\t\t</td>"
						+ "\n\t\t\t\t\t\t\t\t\t</tr>";
		...
		request.setAttribute("eventTrashedMessage", result);
	}
}
