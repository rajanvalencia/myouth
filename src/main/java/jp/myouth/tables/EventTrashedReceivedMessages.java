...
public class EventTrashedReceivedMessages {
	...
	public void append(HttpServletRequest request) {
		...
		db.open();
		ArrayList<String> data = db.eventTrashedReceivedMessages(event);
		db.close();
		...
		for(String string : data) {
			if(i % 4 == 0)
				result += "<tr><td><a href=\"/home/"+event+"/mail/trashedInbox/"+string+"\" style=\"color: #777;\"><div class=\"row gtr-50 gtr-uniform\">";
			else if(i % 4 == 1)
		...
		request.setAttribute("eventTrashedReceivedMessages", result);
	}
}
