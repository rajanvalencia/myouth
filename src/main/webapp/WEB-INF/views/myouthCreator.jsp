			...
			<div class="row">
				<div class="col-12">
					...
					<div class="row">
						...
						<div class="col-6 col-12-mobilep">
						<h4>資格   <span class="fas fa-award faa-shake animated"></span></h4>
						<ul>
						<li>日本語能力試験 1 級</li>
						<li>TOEIC 890点</li>
						</ul>
						
						<h4>Database   <span class="fa fa-database faa-horizontal animated"></span></h4>
						<ul>
						<li>MariaDB</li>
						</ul>
						</div>
						...
						<div class="col-6 col-12-mobilep">
						<h4>AWS   <span class="fa fa-cloud faa-passing animated"></span></h4>
						<ul>
						...
						<div class="col-6 col-12-mobilep">
						<h4>その他   <span class="fa fa-question-circle  faa-bounce animated"></span></h4>
						<ul>
					...
					<div class="col-6 col-12-mobilep">
					<h4>ツール   <span class="fa fa-wrench faa-wrench animated"></span></h4>
					<ul>
					<li>CentOS 7</li>
					<li>OpenGL</li>
					<li>G++</li>
					...
					<p>TCCとは何か、と知りたい方はこちらの<a href="https://content.sciendo.com/view/journals/amcs/25/4/article-p723.xml">論文</a>をお読みください。
					ダウンロードまたは利用方法はGitHubを参照してください。</p>
					<span class="image fit"><img src="https://s3-ap-northeast-1.amazonaws.com/jp.myouth.images/rajanValencia/TCC1.png"></span>
					<span class="image fit"><img src="https://s3-ap-northeast-1.amazonaws.com/jp.myouth.images/rajanValencia/TCC2.png"></span>
					</section>
