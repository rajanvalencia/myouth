...
<body class="is-preload">
	...
	<div id="header">
		...
		<div class="top">
			...
			<!-- Logo -->
			<div id="logo">
				<span class="image avatar48"><img src="<%out.print(db.eventLogo(event));%>" alt="" /></span>
			</div>

			<span><%out.print(eventName);%></span>
	...
	<script type="text/javascript">
		...
		function drawMap() {
			var data = google.visualization
					.arrayToDataTable([
	["ルーツをもつ国","参加人数"],["", 22],["Bangladesh", 1],["Brazil", 1],["Cambodia", 1],["China", 15],["India", 2],["Indonesia", 1],["Japan", 11],["Korea", 1],["Mongolia", 1],["Nepal", 1],["Pakistan", 2],["Peru", 2],["Philippines", 6],["Sri Lanka", 2],["Taiwan", 1],["Vietnam", 2]
		]);
			var options = {
				title : 'ルーツをもつ国別参加者'
			};
	...
	<script type="text/javascript">
		...
		function drawChart() {
			...
			var data = google.visualization
					.arrayToDataTable([
	["職種","割合"],["会社員", 2.4390],["公務員", 2.4390],["大学生", 46.3415],["大学院生", 9.7561],["専門学生", 2.4390],["教員", 2.4390],["浪人生", 2.4390],["高校生", 31.7073]
		]);
	...
	<script type="text/javascript">
		...
		function drawChart() {
			...
			var data = google.visualization
					.arrayToDataTable([
	["きっかけ","割合"],["先生または講師の方", 2.4390],["先生や講師の方", 9.7561],["友人または知り合い", 73.1707],["実行委員", 14.6341]
		]);
