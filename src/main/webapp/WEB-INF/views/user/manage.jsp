	...
	<div id="wrapper">
		...
		<section id="main">
			...
			<ul class="actions special">
				<li><a href="/home/events/<%out.print(event);%>/details"
					class="button">詳細の変更</a></li>
			</ul>
			<ul class="actions special">
				<li><a href="/home/events/<%out.print(event);%>/participants"
					class="button">参加者一覧</a></li>
			</ul>
			<ul class="actions special">
				<li><a href="/home/events/<%out.print(event);%>/register"
					class="button">メンバーの管理</a></li>
			</ul>
			<ul class="actions special">
				<li><a href="/home/events/<%out.print(event);%>/download"
					class="button">ダウンロード</a></li>
			</ul>
			<ul class="actions special">
				<li><a href="/home/events/<%out.print(event);%>/delete"
					class="button">イベント削除</a></li>
			</ul>
			<hr />
			<footer>
				<ul class="icons">
					<li><a href="/home/events" class="fa-arrow-left">Back</a></li>
