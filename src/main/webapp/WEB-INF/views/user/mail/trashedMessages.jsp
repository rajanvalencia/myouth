					...
					<section class="box">
						<div class="row gtr-50 gtr-uniform">
							...
							<div class="col-1 col-2-mobile">
								<a href="/home/<%out.print(event);%>/mail/trashed/deleteAllTrashedMessages" style="border-bottom: transparent"><span class="fa fa-trash fa-2x"></span></a>
							</div>
						</div>
						<br />
						<% 
							EventTrashedMessages list = new EventTrashedMessages();
							list.append(request);
							out.print(request.getAttribute("eventTrashedMessages"));
							request.removeAttribute("eventTrashedMessages");
						%>
					</section>
				</div>
			</div>
