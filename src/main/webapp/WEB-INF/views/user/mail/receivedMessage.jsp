	...
	<div id="page-wrapper">
		...
		<section id="main" class="container">
			<section  class="back-button">
				<a href="/home/<%out.print(event);%>/mail/inbox"><span class="fas fa-arrow-left fa-2x faa-passing-reverse animated"></span></a>
			</section>
			<div class="row">
				<div class="col-12">
					<section class="box">
						<% 
							EventReceivedMessage list = new EventReceivedMessage();
							list.append(request, response);
							out.print(request.getAttribute("eventReceivedMessage"));
							request.removeAttribute("eventReceivedMessage");
						%>
					</section>
				</div>
			</div>
