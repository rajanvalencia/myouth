...
<%
	...
	String replyTo = (String) session.getAttribute("replyTo");
	if(replyTo == null)
		replyTo = "";
...
<body class="is-preload">
						...
						<form id="form" method="post" action="/sendMessage">
							<div class="row gtr-uniform gtr-50">
								<div class="col-4 col-12-narrower">
									<input type="radio" id="multiple" name="recipientType" value="multiple" onclick="$('#recipientField').addClass('hidden'); $('#multipleRecipientsField,#multipleRecipientsField1,#multipleRecipientsField2,#multipleRecipientsField3').removeClass('hidden')" checked> 
									<label for="multiple">一斉送信</label>
								</div>
								<div class="col-4 col-12-narrower">
									<input type="radio" id="specified" name="recipientType" value="specified" onclick="$('#recipientField').removeClass('hidden'); $('#multipleRecipientsField,#multipleRecipientsField1,#multipleRecipientsField2,#multipleRecipientsField3').addClass('hidden')"> 
									<label for="specified">指定</label>
								</div>
								<div id="multipleRecipientsField" class="col-12">
									<label for="">参加者の申し込み期間を選択</label>
								</div>
								<div id="multipleRecipientsField1" class="col-4 col-12-narrower">
									<input type="radio" id="allPeriod" name="periodType" value="allPeriod" checked> 
									<label for="allPeriod">全期間</label>
								</div>
								<div id="multipleRecipientsField2" class="col-4 col-12-narrower">
									<input type="radio" id="recruitmentPeriod" name="periodType" value="recruitmentPeriod"> 
									<label for="recruitmentPeriod">募集期間内</label>
								</div>
								<div id="multipleRecipientsField3" class="col-4 col-12-narrower">
									<input type="radio" id="freePeriod" name="periodType" value="freePeriod"> 
									<label for="freePeriod">期間指定</label>
								</div>
								<div class="col-4 col-4-mobilep hidden" id="startYearRadio">
									<label for="startYear">開始期間</label> 
	...
	<% 
		if(replyTo.length() > 0)
			out.println("<script>$(function(){$('#multiple').attr('checked', false); $('#specified').attr('checked', true); $('#recipientField').removeClass('hidden'); $('#multipleRecipientsField,#multipleRecipientsField1,#multipleRecipientsField2,#multipleRecipientsField3').addClass('hidden');});</script>");
