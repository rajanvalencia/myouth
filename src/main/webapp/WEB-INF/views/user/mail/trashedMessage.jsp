	...
	<div id="page-wrapper">
		...
		<section id="main" class="container">
			<section  class="back-button">
				<a href="/home/<%out.print(event);%>/mail/trashed"><span class="fas fa-arrow-left fa-2x faa-passing-reverse animated"></span></a>
			</section>
			<div class="row">
				<div class="col-12">
					<section class="box">
						<% 
							EventTrashedMessage list = new EventTrashedMessage();
							list.append(request, response);
							out.print(request.getAttribute("eventTrashedMessage"));
							request.removeAttribute("eventTrashedMessage");
						%>
					</section>
				</div>
			</div>
