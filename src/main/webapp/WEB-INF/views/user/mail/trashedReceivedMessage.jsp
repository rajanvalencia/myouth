	...
	<div id="page-wrapper">
		...
		<section id="main" class="container">
			<section  class="back-button">
				<a href="/home/<%out.print(event);%>/mail/trashedInbox"><span class="fas fa-arrow-left fa-2x faa-passing-reverse animated"></span></a>
			</section>
			<div class="row">
				<div class="col-12">
					<section class="box">
						<% 
							EventTrashedReceivedMessage list = new EventTrashedReceivedMessage();
							list.append(request, response);
							out.print(request.getAttribute("eventTrashedReceivedMessage"));
							request.removeAttribute("eventTrashedReceivedMessage");
						%>
					</section>
				</div>
			</div>
