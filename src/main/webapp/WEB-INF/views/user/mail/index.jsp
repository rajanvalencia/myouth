						 ...
						 <div class="table-wrapper">
							<table>
								<tbody>
									<tr>
										<td>
											<a href="/home/<%out.print(event);%>/mail/create" style="color: #e89980; border-bottom-color: transparent;">
									...
									<tr>
										<td>
											<a href="/home/<%out.print(event);%>/mail/inbox" style="color: #e89980; border-bottom-color: transparent;">
												<div class="row gtr-50 gtr-uniform">
													<div class="col-4">
									...
									<tr>
										<td>
											<a href="/home/<%out.print(event);%>/mail/sent"  style="color: #e89980; border-bottom-color: transparent;">
												<div class="row gtr-50 gtr-uniform">
													<div class="col-4">
									...
									<tr>
										<td>
											<a href="/home/<%out.print(event);%>/mail/trashedInbox"  style="color: #e89980; border-bottom-color: transparent;">
												<div class="row gtr-50 gtr-uniform">
													<div class="col-4">
									...
									<tr>
										<td>
											<a href="/home/<%out.print(event);%>/mail/trashed"  style="color: #e89980; border-bottom-color: transparent;">
												<div class="row gtr-50 gtr-uniform">
													<div class="col-4">
														<span class="fa fa-trash fa-2x"></span>
													</div>
