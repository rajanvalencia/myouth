		...
		<a href="/home"><span class="fas fa-arrow-left fa-2x faa-passing-reverse animated"></span></a>
			...
			<div class="row">
				<div class="col-12">
					...
					<!-- Image -->
					<section class="box">
						<span class="image fit"><img style="border-radius: 10px;" src="<% out.print(session.getAttribute("photoUrl"));%>" alt=""/></span>
						<form method="post" action="/updateEventImageDescription">
							<div class="row gtr-50 gtr-uniform">
								<div class="col-12">
									<label for="description">コメントを追加</label>
									<input id="description" type="text" name="imageDescription" value="">
								</div>
								<div class="col-12">
									<ul class="actions">
