...
<body class="is-preload">
	<div id="page-wrapper">
		...
		<section  class="back-button">
			<a href="/home/${event}/visualization/analytics"><span class="fas fa-arrow-left fa-2x faa-passing-reverse animated"></span></a>
		</section>
			<div class="row">
				<div class="col-12">
					<section class="box">
						${analyticsPageHtmlContent}
					</section>
				</div>
			</div>
			<section  class="back-button">
	...
	<script src="/resources/js/analytics-requests-api.js"></script>
	<!-- amCharts Resources -->
